...
This module covers extensions and advanced topics.
It is not required for core tutorial completion.

WorkGraph vs WorkChain:

Modules 3 used **WorkGraph** to build workflows — a declarative, graph-based approach where you wire tasks together.
...
TODO: 2D parameter scan over F and k to map the full phase diagram TODO: visualize the phase diagram as a heatmap of variance_V TODO: identify different pattern regimes (spots, stripes, labyrinthine)

## FFT analysis

TODO: write a calcfunction that computes the 2D FFT of V_final TODO: extract the dominant wavelength TODO: plot wavelength vs F
