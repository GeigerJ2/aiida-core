...
from aiida.tools.dumping.managers.nodes import NodeProcessor
from aiida.tools.dumping.managers.groups import GroupManager
...
class DumpEngine:
    ...
    def __init__(self, config: DumpConfig, dump_paths: DumpPaths):
        ...
        self.node_processor = NodeProcessor(config, dump_paths, self.dump_logger)
        self.group_manager = GroupManager(config, dump_paths, self.dump_logger, node_processor=self.node_processor)
