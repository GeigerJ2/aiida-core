...
class NodeRepoIoDumper:
    ...
    def dump_calculation_content(self, calculation_node: orm.CalculationNode, output_path: Path) -> None:
        ...
        if self.config.include_outputs:
            ...
            try:
                ...
                output_links_filtered = [lt for lt in output_links if lt.link_label != 'retrieved']
...
class WorkflowWalker:
    ...
    def dump_children(self, workflow_node: orm.WorkflowNode, output_path: Path) -> None:
        ...
        for index, link_triple in enumerate(called_links, start=1):
            ...
            child_label = ProcessNodeManager._generate_child_node_label(index=index, link_triple=link_triple)
...
class ReadmeGenerator:
    ...
    def generate(self, process_node: orm.ProcessNode, output_path: Path) -> None:
        ...
        try:
            ...
            logger.warning('Could not import AiiDA cmdline utils for README generation. Skipping.')
            return
